...
public class DatabaseLoader {
    ...
    public static void loadMood(MoodRepository moodRepository, MoodContentRepository moodContentRepository) {
    ...
    public static void loadAward(AwardRepository awardRepository) {
